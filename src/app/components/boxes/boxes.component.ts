...
export class BoxesComponent {
  ...
  cards = [
    ...
    { id: 2, name: 'Box 2', brand: 'Panini', sport: 'Basketball', description: '2021-22 National Treasures Hobby Box', price:'$2,000', img: '21-22_nt_basketball.png' },
    { id: 3, name: 'Box 3', brand: 'Panini', sport: 'Basketball', description: '2022-23 Prizm Hobby Box', price:'$1,000', img: '22-23_Prizm_basketball.png' },
    ...
    { id: 8, name: 'Box 8', brand: 'Panini', sport: 'Football', description: '2023 Immaculate Football Hobby Box', price:'$1,500', img: '2023_immaculate_fb.png' },
    { id: 9, name: 'Box 9', brand: 'Panini', sport: 'Football', description: '2023 Optic Football Hobby Box', price:'$700', img: '2023_Optic_fb.png' },
    { id: 10, name: 'Box 10', brand: 'Topps', sport: 'Baseball', description: '2023 Topps Dynasty Hobby Box', price:'$1,500', img: '2023_dynasty_baseball.jpg' },
